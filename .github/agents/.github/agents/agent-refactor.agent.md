---
name: Agent Refactor — MusicMaker
description: "Extracts shared data to reference files and enforces spec compliance across all agent documentation in MusicMaker"
