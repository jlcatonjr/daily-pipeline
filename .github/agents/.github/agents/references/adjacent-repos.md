...
# Adjacent Repository Registry — MusicMaker

This file is the authoritative registry of repositories adjacent to **MusicMaker** whose agent infrastructure may be affected by — or may affect — activity in this project.
