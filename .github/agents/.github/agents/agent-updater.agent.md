---
name: Agent Updater — MusicMaker
description: "Synchronizes agent documentation after project structure, deliverable, or reference changes in MusicMaker"
...
# Agent Updater — MusicMaker

You synchronize agent documentation after changes in MusicMaker. When deliverables are added, references change, the project structure evolves, or style rules are updated, you update all affected agent files.
...
|---------------------|-----------------|
| `src/*` | `@conflict-auditor`, `@primary-producer`, `@style-guardian`, `@navigator` |
| `docs/reference-db.md` | `@reference-manager`, `@output-compiler` |
