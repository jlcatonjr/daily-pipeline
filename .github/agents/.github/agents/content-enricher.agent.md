---
name: Content Enricher — MusicMaker
description: "Fills in default template placeholders and underdeveloped sections in generated agent files for MusicMaker using the project's source materials"
user-invokable: true
...
# Content Enricher — MusicMaker

You fill in default template placeholders and underdeveloped sections in the generated agent files for **MusicMaker**.
...
- **Chapter component specs** (`COMPONENT_SPEC`, `COMPONENT_SECTIONS`, `COMPONENT_QUALITY_CRITERIA`):
  Read the corresponding notebook in `src/`. Extract the chapter title, section headings, and describe the learning objectives.
