...
- `UNKNOWN-CVE` | Unknown vendor Catalyst SD-WAN Manger | Known exploited vulnerability | added n/a
- `UNKNOWN-CVE` | Unknown vendor Catalyst SD-WAN Manager | Known exploited vulnerability | added n/a
- `UNKNOWN-CVE` | Unknown vendor Kentico Xperience | Known exploited vulnerability | added n/a
- `UNKNOWN-CVE` | Unknown vendor NG/MF | Known exploited vulnerability | added n/a
- `UNKNOWN-CVE` | Unknown vendor Zimbra Collaboration Suite (ZCS) | Known exploited vulnerability | added n/a
- `UNKNOWN-CVE` | Unknown vendor Catalyst SD-WAN Manager | Known exploited vulnerability | added n/a
- `UNKNOWN-CVE` | Unknown vendor KACE Systems Management Appliance (SMA) | Known exploited vulnerability | added n/a
- `UNKNOWN-CVE` | Unknown vendor TeamCity | Known exploited vulnerability | added n/a
- `UNKNOWN-CVE` | Unknown vendor ActiveMQ | Known exploited vulnerability | added n/a
